...
- Environment: Varlock resolves Firebase `VITE_*` values from KeePass-backed `.env.schema`; temporary `NEXT_PUBLIC_FIREBASE_*` aliases exist for the Next route migration.
